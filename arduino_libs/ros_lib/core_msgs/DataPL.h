#ifndef _ROS_core_msgs_DataPL_h
#define _ROS_core_msgs_DataPL_h
...
namespace core_msgs
{
  ...
  class DataPL : public ros::Msg
  {
    public:
      ...
      typedef core_msgs::KeyValue _states_type;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(states_lengthT > states_length)
        this->states = (core_msgs::KeyValue*)realloc(this->states, states_lengthT * sizeof(core_msgs::KeyValue));
      states_length = states_lengthT;
      for( uint32_t i = 0; i < states_length; i++){
      offset += this->st_states.deserialize(inbuffer + offset);
        memcpy( &(this->states[i]), &(this->st_states), sizeof(core_msgs::KeyValue));
      }
     return offset;
    }

    const char * getType(){ return "core_msgs/DataPL"; };
    const char * getMD5(){ return "50373f3d30586584bdf8490e188e9d57"; };
